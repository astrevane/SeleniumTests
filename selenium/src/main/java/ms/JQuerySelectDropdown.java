...
final public class JQuerySelectDropdown {
    ...
    static private WebElement getSearchPrompt(WebDriver driver) {
        return driver.findElement(By.cssSelector("span.select2-search > input:nth-child(1)"));
    }
    static private WebElement getTerritoryDropdown(WebDriver driver) {
    ...
    static public void selectCountry(WebDriver driver, String country) {     
        ...
        getSearchPrompt(driver).sendKeys(country);
    ...
    static public void selectTerritory(WebDriver driver, String territory) {     
        getTerritoryDropdown(driver).click();
        getSearchPrompt(driver).sendKeys(territory);
        driver.findElement(By.xpath("//li[text()='" + territory + "']")).click();        
    }
    static public String getSelectedTerritory(WebDriver driver) {
        return getTerritoryDropdown(driver).getText();
    }
